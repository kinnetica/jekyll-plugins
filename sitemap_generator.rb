...
#       layout, ... 
#   2.) Sites using pagination should be able to use this plugin as well. All of 
#       the pages generated by the pagination process will have the same 
#       metadata as the index.html file.
#
